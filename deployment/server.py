...
try:
    pipeline_path = 'trained_pipeline.joblib'  # Ensure this path points to the saved pipeline file
...
if __name__ == '__main__':
    port = os.getenv('FLASK_PORT', 8000)  # Change '8000' to another port number if 8000 is already in use or set FLASK_PORT environment variable
